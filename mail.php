...
$BccMail = "design_section_07@senkyo-pro.com";

// 管理者宛に送信されるメールのタイトル（件名）
$subject = "後援会入会フォームからのお問い合わせ";
...
$thanksPage = "https://kajiwara-hideki.com/thanks.html";
...
<meta name="description" content="山科区　かじわら英樹後援会入会フォーム確認画面" />
<meta name="keywords" content="かじわら英樹,後援会,入会,申込書,山科区,京都府,選挙,確認画面" />
<meta name="robots" content="index,follow">
<link rel="stylesheet" href="css/reset.css" type="text/css">
<link rel="stylesheet" href="css/style.css" type="text/css">
   <link rel="stylesheet" href="css/suporter.css" type="text/css">
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;500;700;900&display=swap" rel="stylesheet">
<title>かじわら英樹後援会入会フォーム確認画面</title>
</head>
<body>
...
<?php }else{ ?>
<h3 class="php_title">入力内容確認画面</h3>
<p class="php_text">以下の内容で間違いがなければ、「送信する」ボタンを押してください。</p>
...
<div class="submit_php">
<input type="submit" value="　送信する　">
</div>
<input type="button" value="前画面に戻る" class="return_btn" onClick="history.back()">
</div>
</form>
<?php } ?>
</div><!-- /formWrap -->
